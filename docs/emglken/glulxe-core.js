...
if (Module["locateFile"]) {
 wasmBinaryFile = "glulxe-core.wasm";
 if (!isDataURI(wasmBinaryFile)) {
  wasmBinaryFile = locateFile(wasmBinaryFile);
 }
} else {
 wasmBinaryFile = new URL("glulxe-core.wasm", import.meta.url).href;
}
...
var wasmImports = {
 ...
 "l": _fd_seek,
 "i": _fd_write,
 "g": glk_buffer_canon_decompose_uni,
 "f": glk_buffer_canon_normalize_uni,
 "e": glk_buffer_to_lower_case_uni,
 "d": glk_buffer_to_title_case_uni,
 "c": glk_buffer_to_upper_case_uni
};
...
var _malloc = function() {
 return (_malloc = Module["asm"]["D"]).apply(null, arguments);
};

var _free = function() {
 return (_free = Module["asm"]["E"]).apply(null, arguments);
};
...
var _gidispatch_get_game_id = Module["_gidispatch_get_game_id"] = function() {
 return (_gidispatch_get_game_id = Module["_gidispatch_get_game_id"] = Module["asm"]["G"]).apply(null, arguments);
};
...
var ___errno_location = function() {
 return (___errno_location = Module["asm"]["I"]).apply(null, arguments);
};

var ___funcs_on_exit = function() {
 return (___funcs_on_exit = Module["asm"]["J"]).apply(null, arguments);
};
...
var _asyncify_start_unwind = function() {
 return (_asyncify_start_unwind = Module["asm"]["M"]).apply(null, arguments);
};

var _asyncify_stop_unwind = function() {
 return (_asyncify_stop_unwind = Module["asm"]["N"]).apply(null, arguments);
};

var _asyncify_start_rewind = function() {
 return (_asyncify_start_rewind = Module["asm"]["O"]).apply(null, arguments);
};

var _asyncify_stop_rewind = function() {
 return (_asyncify_stop_rewind = Module["asm"]["P"]).apply(null, arguments);
};

var ___start_em_js = Module["___start_em_js"] = 39312;

var ___stop_em_js = Module["___stop_em_js"] = 41997;
